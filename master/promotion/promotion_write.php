		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<form action="./promotion_write_action.php" method="post" enctype="multipart/form-data" name="frm" target="_fra_admin" id="frm">
						...
						<div class="write">
							<table>
								...
								<tr>
									...
									<td><input type="text" name="location" style="width: 100%" required="yes" message="병원 위치"></td>
									<th scope="row">시술명</th>
									<td>
										<textarea name="procedure" id="" rows="1"  style="width: 100%; height:32px; resize:none; padding:5px 10px;" required="yes" message="시술명"></textarea>
									</td>
										<!-- <input type="text" name="procedure" style="width: 100%" required="yes" message="시술명"></td> -->
								</tr>

								<tr>
									<th scope="row">프로모션 여부</th>
									<td>
										<input type="radio" name="is_promotion" value="Y"> 예&nbsp;&nbsp;&nbsp;
										<input type="radio" name="is_promotion" value="N"> 아니오
									</td>
									<th scope="row">재고 수량</th>
									<td><input type="text" name="amount" style="width: 100%" required="yes" message="재고 수량"></td>
								</tr>

								<tr>
									<th scope="row">병원 정보</th>
									<td colspan="3">
										<textarea name="hospital_info"></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="major_procedures"></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="operating_time"></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<textarea name="hospital_pos"></textarea>
									</td>
								</tr>
									...
									<td colspan="3">
										<table style="margin-bottom: 0px !important;">
											...
											<tr>
												...
												<td colspan="3"><input type="file" name="banner_file" required="true" message="병원 배너 이미지" accept="image/*"></td>
											</tr>

											<tr>
												<th scope="row">병원 내부</th>
												<td colspan="3"><input type="file" name="hospital_in_file" required="true" message="병원 내부 이미지" accept="image/*"></td>
											</tr>

											<tr>
												<th scope="row">병원 전경</th>
												<td colspan="3"><input type="file" name="hospital_view_file" required="true" message="병원 전경 이미지" accept="image/*"></td>
											</tr>

											<tr>
												<th scope="row">로고 이미지</th>
												<td colspan="3"><input type="file" name="logo_file" required="true" message="로고 이미지" accept="image/*"></td>
											</tr>
			...
			<script>
				function custom_log($message) {
					file_put_contents("/path/to/log/file.log", $message, FILE_APPEND);
				}
			</script>
