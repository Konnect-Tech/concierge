...
<body>
    <div id="wrap">
        <header id="header">
            ...
            <div class="header__title">积分</div>
        </header>
        <main class="main">
            <div class="mypage__container">
                <section class="mypage-point">
                    <div class="mypage-tab">
                        <a href="/cn/mypage/point_save.php" class="tab">积分</a>
                        <a href="/cn/mypage/point_use.php" class="tab on">使用</a>
                    </div>
                    <div class="point-category">
						<!-- 클릭 시 해당 분류로 필터링 -->
						<a href="./<?=basename($_SERVER['PHP_SELF'])?>?type=all" <?php if($type === "all"){ echo 'class="on"'; } ?>>全部</a>
						<a href="./<?=basename($_SERVER['PHP_SELF'])?>?type=d" <?php if($type === "d"){ echo 'class="on"'; } ?>>D积分</a>
						<a href="./<?=basename($_SERVER['PHP_SELF'])?>?type=m" <?php if($type === "m"){ echo 'class="on"'; } ?>>M积分</a>
                    </div>
