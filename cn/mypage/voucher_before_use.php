            ...
            <div class="mypage__container">
                <section class="mypage-point">
                    <div class="mypage-tab">
                        <a href="/cn/mypage/voucher_before_use.php" class="tab on">使用前</a>
                        <a href="/cn/mypage/voucher_after_use.php" class="tab">使用后</a>
                    </div>
...
<script>
    ...
    window.onload = function getVoucher() {
        ...
        success:function(result){
            ...
            console.log(result.data.length,"1111111111111111111111")
...
<script>
    function test(data){
        console.log(data);
        window.location.href = "/cn/mypage/voucher_use_detail.php?data="+data;
    }
</script>
