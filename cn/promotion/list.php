							...
							for($i = 0, $iMax = $promotion_result->num_rows; $i < $iMax; $i ++){
								...
								<div class="promotion__item">
									...
									<div class="promotion_btn">
										...
										<div class="btns">
											<a href="./detail.php?idx=<?=$row['idx']?>" class="btn_reserv">点击预约</a>
